...
class FundController extends Controller
{
    ...
    public function allDailyFunds( Request $request )
    {
        try
        {
            ...
            $fund_id = $request->input( 'fund' );
            $date = $request->input( 'date' );
            $data     = DailyFunds::getAllDailyFunds( $offset, $per_page, $fund_id, $date );
    ...
    public static function updateFund( Request $request )
    {
        try
        {
            ...
            $data        = Funds::updateFund( $fund_id, $description );
    ...
    {
        $funds = DailyFunds::find($request->id);
        $funds->price = $request->price;
        if($funds->save()) {
